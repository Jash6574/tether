...
class CoinnameHitBTC extends StatefulWidget {
  final String name;
  final HitBTCitem data;
  const CoinnameHitBTC({
    Key? key,
    required this.name,
    required this.data,
  }) : super(key: key);
  ...
  @override
  State<CoinnameHitBTC> createState() => _CoinnameHitBTCState();
}

class _CoinnameHitBTCState extends State<CoinnameHitBTC> {
  @override
                    ...
                    children: [
                      ListTile(
                        leading: "Ask"
                            ...
                            .make()
                            .px12(),
                        trailing: widget.data.ask!.text.lg.make().px12(),
                      ),
                      ListTile(
                        leading: "Bid"
                            .text
                            ...
                            .make()
                            .px12(),
                        trailing: widget.data.bid!.text.lg.make().px12(),
                      ),
                      ListTile(
                        leading: "Last"
                            .text
                    ...
                    children: [
                      ...
                      ListTile(
                        leading: "Volume Quote"
                            ...
                            .px12(),
                        trailing:
                            widget.data.volumeQuote!.text.lg.make().px12(),
                      ),
                    ],
                  ),
                ),
